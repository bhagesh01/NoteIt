...
const About = () => {
  return (
    <div className="h-heightWithoutNavbar flex flex-col items-center justify-start p-5 lg:flex-row text-white">
      ...
      <div className="flex h-full gap-5 w-full flex-col items-center justify-center">
        <div className="">
        ...
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3 mb-5">
